'use strict';
app.controller('eventoPublicidadABMController', ['$scope', 'eventoPublicidadService', 'Upload', 'commonService', 'authService', '$rootScope', 'toastr', '$routeParams', '$timeout',
function ($scope, eventoPublicidadService, Upload, commonService, authService, $rootScope, toastr, $routeParams, $timeout) {
    $scope.publicidad = {};
    ...
    angular.element(function () {
        ...
        if (publicidadId != null) {
            ...
            return eventoPublicidadService.getPublicidadById(publicidadId).then(function (response) {
    ...
    $scope.savePublicidad = function () {
        return eventoPublicidadService.savePublicidad($scope.publicidad, $scope.f).then(function (response) {
            if (response.data == "Ok") {
