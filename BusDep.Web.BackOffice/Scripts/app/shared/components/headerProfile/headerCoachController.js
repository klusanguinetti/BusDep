app.controller('headerCoachController', ['$scope', 'headerCoachService', 'commonService', '$http', 'Flash', 'Upload', '$timeout',  '$rootScope', 'toastr',
function ($scope, headerCoachService, commonService, $http, Flash, Upload, $timeout, $rootScope, toastr) {
